...
public class GuiInfuser extends GuiContainer
{
    ...
    protected void drawGuiContainerBackgroundLayer(float par1, int par2, int par3)
    {
        ...
        this.mc.renderEngine.bindTexture("/mods/glowTools/textures/gui/gui.gsInfuser.png");
        ...
        if (this.infuserInventory.hasGlowFuel())
        {
        	i1 = this.infuserInventory.getCurrentGlowAmount();
        	this.drawTexturedModalRect(k, l, 176, 69 - i1, 6, i1 + 2);
        }
