...
public class BlockGlowstoneInfuser extends BlockContainer
{
    ...
    {
        return GlowTools.GlowstoneInfuser.blockID;
    }
    ...
    public static void updateInfuserBlockState(boolean par0, World par1World, int par2, int par3, int par4)
    {
        ...
        if (par0)
        {
            par1World.setBlock(par2, par3, par4, GlowTools.GlowstoneInfuserActive.blockID);
        }
        else
        {
            par1World.setBlock(par2, par3, par4, GlowTools.GlowstoneInfuser.blockID);
        }
