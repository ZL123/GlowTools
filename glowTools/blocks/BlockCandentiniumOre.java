...
{	private boolean glowing;
    ...
    private void glow(World par1World, int par2, int par3, int par4)
    {
        ...
        if (this.blockID == GlowTools.CandentiniumOre.blockID)
        {
            par1World.setBlock(par2, par3, par4, GlowTools.CandentiniumOreGlowing.blockID);
        }
    }
    
    public void updateTick(World par1World, int par2, int par3, int par4, Random par5Random)
    {
        if (this.blockID == GlowTools.CandentiniumOreGlowing.blockID)
        {
            par1World.setBlock(par2, par3, par4, GlowTools.CandentiniumOreGlowing.blockID);
        }
    }
    ...
    {
        return GlowTools.CandentiniumGem.itemID;
    }
    ...
    {
        return new ItemStack(GlowTools.CandentiniumOre);
    }
