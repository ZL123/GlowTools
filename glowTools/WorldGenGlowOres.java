	...
	public void generate(Random random, int chunkX, int chunkZ, World world,
		...
		public void generateNether(World world, Random rand, int chunkX, int chunkZ)
		{
			for (int i = 0; i < 2; i++)
			{
				...
				(new WorldGenMinable(GlowTools.BlueGlassOre.blockID, 14, Block.netherrack.blockID))
		...
		public void generateOverworld(World world, Random rand, int chunkX, int chunkZ)
		{
			...
			for (int i = 0; i < 2; i++)
			{
				...
				(new WorldGenMinable(GlowTools.CandentiniumOre.blockID, 8)).generate(world, rand,
			...
			if(ChunkGenRandNum == 1){
				for (int i = 0; i < 4; i++)
				{
					...
					int randPosZ = chunkZ + rand.nextInt(16);
					(new WorldGenMinable(GlowTools.FlowStoneBlock.blockID, 120)).generate(world, rand,
						randPosX, randPosY, randPosZ);
				}
			}
